...
import useStream, { useStreamAudienceMember, useStreamOnStage, useStreamOwners, useStreamRaisedHands } from '../../hooks/useStream'
    ...
    <ListItem
      ...
      renderBefore={(
        <View style={{ position: 'relative' }}>
          ...
          {isRaisingHand && (
            <IconButton style={{ position: 'absolute', top: -8, right: -8 }} size='s' card>
